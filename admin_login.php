  ...
  $nameErr = "Este necesar sa introduceti datele cerute!";
    ...
    if ($emailExists) {
      if ($verificat) {
            ...
            header("Location: your_account_admin.php");
            exit;
    } else {
  ...
  function verifyEmailAndPassword($email, $password)
{
    ...
    $query = "SELECT COUNT(*) AS count FROM user WHERE email = '$sanitizedEmail' AND pwd = '$sanitizedPassword' AND user_type='admin'";
    $result = mysqli_query($db, $query);
  ...
  <div class="grid-container">
    <div class="grid-x grid-margin-x">
      ...
      <form style="padding-top: 60px;" name="adaugare" id="adaugare" method="POST">
              ...
              <a style="display: block; color: black; padding-top: 20px;" href="admin_signup.php">
