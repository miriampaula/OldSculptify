  ...
  function verifyEmailAndPassword($email, $password)
{
    ...
    $query = "SELECT COUNT(*) AS count FROM user WHERE email = '$sanitizedEmail' AND pwd = '$sanitizedPassword' AND user_type='user'";
    $result = mysqli_query($db, $query);
  ...
  <div class="grid-container">
    <div class="grid-x grid-margin-x">
      ...
      <form style="padding-top: 60px;" name="adaugare" id="adaugare" method="POST">
              ...
              <a style="display: block; color: black; padding-top: 20px;" href="user_signup.php">
