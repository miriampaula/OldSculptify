...
<div id="dropdownToggle" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-72 dark:bg-gray-700 dark:divide-gray-600">
  ...
  <div class="grid-container">
    <div class="grid-x grid-margin-x" style="padding-top: 50px;">
      <div class="cell small-12 medium-6 large-4" style="padding:2%;">
        <a href="recipe1.php"><img src="imgs/recipe-image-legacy-id-208452_11-6b900aa.webp"></a>
        <p class="recipe-name-list">Curried kale & chickpea soup</p>
      ...
      <div class="cell small-12 medium-6 large-4" style="padding:2%">
        <a href="recipe1.php"><img src="imgs/Salsa-verde-baked-eggs-80334f1.webp"></a>
        <p class="recipe-name-list">Salsa Verde Baked Eggs</p>
        <ul style="width: 100%;" class="menu">
          <li style="width: 50%; text-align: center;">
            <div class="add">
            <button class="round-6">+</button>
      ...
      <div class="cell small-12 medium-6 large-4" style="padding:2%">
        <a href="recipe1.php"><img src="imgs/Carrot-Pilaf-With-Coriander-Chutney-8b7acf4.webp"></a>
        <p class="recipe-name-list">Carrot Pilaf with Coriander Chutney</p>
        <ul style="width: 100%;" class="menu">
          <li style="width: 50%; text-align: center;">
            <div class="add">
            <button class="round-6">+</button>
      ...
      </div><div class="cell small-12 medium-6 large-4" style="padding:2%">
        <a href="recipe1.php"><img src="imgs/Lemon-orzo-chicken-b2724eb.webp"></a>
        <p class="recipe-name-list">Lemon orzo Chicken</p>
        <ul style="width: 100%;" class="menu">
          <li style="width: 50%; text-align: center;">
            <div class="add">
            <button class="round-6">+</button>
        ...
        <a href="recipe1.php"><img src="imgs/recipe-image-legacy-id-363748_11-2836758.webp"></a>
        <p class="recipe-name-list">Curried kale & chickpea soup</p>
        <ul style="width: 100%;" class="menu">
          <li style="width: 50%; text-align: center;">
            <div class="add">
