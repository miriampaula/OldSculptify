...
$recipe_name = $recipe_image = $servings =  $calories = $time = $description  = $directions = $prot = $carbs = $fats = $fibers = $sugar = "";
...
if ((empty($_POST["recipe_name"])) && (empty($_POST["calories"])) && (empty($_POST["directions"]))) {
  ...
  $stmt = $db->prepare("INSERT INTO recipe (recname, calories, time_to_pret, descripti, directions, grams_protein, grams_carbs, grams_fats, grams_fibers, grams_sugar, recipe_img, servings) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
  $stmt->bind_param("siissdddddsd", $recipe_name, $calories, $time, $description, $directions, $prot, $carbs, $fats, $fibers, $sugar, $recipe_image, $servings);

  $stmt->execute();

  if ($stmt->affected_rows > 0) {
    $insertedId = $stmt->insert_id;
    echo "New record inserted successfully. ID: " . $insertedId;
    echo "Values inserted: <br>";
    echo "Recipe Name: " . $recipe_name . "<br>";
    echo "Calories: " . $calories . "<br>";
    echo "Time to Prepare: " . $time . "<br>";
    echo "Description: " . $description . "<br>";
    echo "Directions: " . $directions . "<br>";
    echo "Protein: " . $prot . "<br>";
    echo "Carbs: " . $carbs . "<br>";
    echo "Fats: " . $fats . "<br>";
    echo "Fibers: " . $fibers . "<br>";
    echo "Sugar: " . $sugar . "<br>";
    echo "Recipe Image: " . $recipe_image . "<br>";
  ...
  $sql = "UPDATE recipe SET recipe_img = '$recipe_image' WHERE id = $registrationId";
  ...
  $sql = "UPDATE recipe SET time_to_pret = '$time' WHERE id = $registrationId";
  ...
  foreach ($ingredients as $ingredient) {
    ...
    $sql =  "INSERT INTO ingredient_for_recipe(ingredient, quantity, recipe_id, measurement) VALUES 
    ('$ingr', '$qty', $registrationId, '$msr')";
    mysqli_query($db, $sql);
  }


  if (isset($_POST['vegan'])) {
    $sql = "INSERT INTO category_for_recipe (category, recipe_id) VALUES ('vegan', $registrationId)";
    mysqli_query($db, $sql);
  }

  if (isset($_POST['gluten_free'])) {
    $sql = "INSERT INTO category_for_recipe (category, recipe_id) VALUES ('gluten_free', $registrationId)";
    mysqli_query($db, $sql);
  }

  if (isset($_POST['quick'])) {
    $sql = "INSERT INTO category_for_recipe (category, recipe_id) VALUES ('quick', $registrationId)";
    mysqli_query($db, $sql);  
  }

  if (isset($_POST['diaryfree'])) {
    $sql = "INSERT INTO category_for_recipe (category, recipe_id) VALUES ('diaryfree', $registrationId)";
    mysqli_query($db, $sql);  
    }

  if (isset($_POST['vegeterian'])) {
    $sql = "INSERT INTO category_for_recipe (category, recipe_id) VALUES ('vegeterian', $registrationId)";
    mysqli_query($db, $sql);  
  }
    ...
    <div class="grid-x grid-margin-x">
      ...
      <form name="adaugare" id="myForm" method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="cell small-10 medium-8 large-8">
          ...
          <input class="input-update" type="text" id="recipe_name" name="recipe_name">
        </div>
      ...
      align-items: center;"></div>
        <div class="cell small-12 medium-8 large-8">
          ...
          <img id="previewImage" src="https://placehold.co/300x200">
        </div>
        ...
        <div class="cell small 12 medium-8 large-8">
          <ul class="menu" style="padding:2%; text-align: center; background-color: rgb(216, 204, 216);">
            <li>Servings</li>
            <input class="input-update" type="text" id="servings" name="servings">
            <li>Calories</li>
            <input class="input-update" type="text" id="calories" name="calories">
            <li>Time to prep</li>
            <input class="input-update" type="text" id="time" name="time">
          </ul>
        ...
        <div style="padding-top: 20px;" class="cell small 12 medium-8 large-8">
          ...
          <textarea class="input-update" id="description" name="description" oninput="adjustTextareaHeight(this)"></textarea>
        </div>
        <div class="cell small-0 medium-2 large-2"></div>
        ...
        <div style="padding-top: 20px;" class="cell small 12 medium-8 large-8">
          ...
          <input type="checkbox" name="vegan" id="option1">
          <label for="option1">vegan</label>

          <input type="checkbox" name="gluten free" id="option2">
          <label for="option2">gluten free</label>

          <input type="checkbox" name="quick" id="option3">
          <label for="option3">quick</label>

          <input type="checkbox" name="diaryfree" id="option4">
          <label for="option4">Diary Free</label>

          <input type="checkbox" name="vegeterian" id="option5">
        ...
        <div style="padding-top: 20px;" class="cell small 12 medium-8 large-8">
          ...
          <table id="ingredients-table" style="margin: 0 auto; border-radius: 30px; overflow: hidden; box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.3); border-collapse: separate;">
            ...
            <tbody id="ingredients-body" style="text-align: left;">
              <tr>
                <td style="width: 20%;"><input class="ingredient_info" name="qty1" type="text"></td>
                <td style="width: 30%;"><input class="ingredient_info" name="msr1" type="text"></td>
                <td style="width: 50%;"><input class="ingredient_info" name="ingr1" type="text"></td>
              </tr>
            </tbody>
          </table>
        ...
        <div style="padding-top: 20px;" class="cell small 12 medium-8 large-8">
          ...
          <p>
            ...
            <textarea class="input-update" id="directions" name="directions" oninput="adjustTextareaHeight(this)"></textarea>
          </p>
        </div>
        <div class="cell small-0 medium-2 large-2"></div>
      ...
      border-collapse: separate;">
            ...
            <tbody class="tabel-alb">
              <tr>
                <td style="width: 30%;">
                  <input class="input-update" type="text" id="cals" name="kcal" readonly>
                </td>
                <td style="width: 60%;">kcal</td>
              </tr>
              <tr>
                <td style="width: 25%;">
                  <input class="input-update" type="text" id="fats" name="fats">
                </td>
                </td>
              ...
              <tr>
                <td style="width: 25%;">
                  <input class="input-update" type="text" id="carbs" name="carbs">
                </td>
              ...
              <tr>
                <td style="width: 25%;">
                  <input class="input-update" type="text" id="sugars" name="sugar">
                </td>
                </td>
              ...
              <tr>
                <td style="width: 25%;">
                  <input class="input-update" type="text" id="fibers" name="fibers">
                </td>
              ...
              <tr>
                <td style="width: 25%;">
                  <input class="input-update" type="text" id="protein" name="prot">
                </td>
  ...
  <script>
    ...
    inputFields.forEach(function(input) {
      input.addEventListener('input', function() {
        ...
        var type = inputName.match(/[a-zA-Z]+/g).join('');
