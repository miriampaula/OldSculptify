...
<body>
  ...
  if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true && isset($_SESSION['email'])) {
    ...
    if ($type == 'professional') {
      echo '<div class="cell small-12 medium-12 large-12 text-center" style="padding-bottom: 60px;">
      <a href="profi-create-plan.php"class="custom-btn2 btn-3" style="width: 250px; height: 50px;" >+ NEW PLAN</a>
    </div> ';
    } else if ($type == 'user') {
      echo '<div class="cell small-12 medium-12 large-12 text-center">
      <a href="create_your_meal_plan.php" class="custom-btn2 btn-3" style="width: 300px;">CREATE YOUR MEAL PLAN</a>
    </div>';
    }
  }
  ?>
      ...
      <div style="padding-top: 40px;" class="cell small-12 medium-6 large-6 text-center">
        <a href="meal-plan-1.php"><img style="height: 100px; width: 400px; object-fit: cover; " src="https://placehold.co/400x100"></a>
      </div>
      <div style="padding-top: 40px;" class="cell small-12 medium-6 large-6 text-center">
        <a href="meal-plan-1.php"><img style="height: 100px; width: 400px; object-fit: cover; " src="https://placehold.co/400x100"></a>
      </div>
